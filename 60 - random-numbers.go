...
// See the `math/rand/v2` package docs for references on other random quantities that Go can provide: https://pkg.go.dev/math/rand/v2

/*
$ go run '60 - random-numbers.go' 
39,53
0.19103043257635022
6.538839183437899,8.143772936757902
94,49
94,49
*/