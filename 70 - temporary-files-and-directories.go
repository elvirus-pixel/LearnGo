...
func main() {
    ...
    // The file name starts with the prefix given as the second argument to `os.CreateTemp` and the rest is chosen automatically to ensure that concurrent calls will always create different file names.
...
/*
$ go run '70 - temporary-files-and-directories.go' 
Temp file name: /tmp/sample1031777959
Temp dir name: /tmp/sampledir3913172628
*/