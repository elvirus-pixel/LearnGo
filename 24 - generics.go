...
// The `comparable` constraint means that we can compare values of this type with the `==` and `!=` operators. For a more thorough explanation of this type signature, see this blog post: https://go.dev/blog/deconstructing-type-parameters
